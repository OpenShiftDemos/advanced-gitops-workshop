...
Now let's look at what groups you are member of:
...
Notice you are not a member of the cluster-admins group, rather you are a member of the `developers` and `team{user-num}`
