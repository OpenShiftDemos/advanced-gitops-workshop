...
[source,yaml,subs="attributes",role=execute]
----
oc patch -n user{usernum}-argocd argocd argocd --type=merge --patch-file=/home/lab-user/workshop/content/modules/ROOT/examples/enable-applicationset/enable-applicationset-patch.yaml
----
