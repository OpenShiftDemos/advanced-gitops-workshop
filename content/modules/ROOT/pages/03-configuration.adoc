...
[NOTE]
In the real world there is no need for sync waves to handle late binding of PVCs, however we are doing so here for
illustrative purposes to show the impact of health checks on behavior.
