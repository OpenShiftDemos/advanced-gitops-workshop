...
some additional alerting in your monitoring for Argo CD Applications you essentially get proactive resource monitoring alerting
for free. OpenShift GitOps includes an an alert for the Out-of-Sync status, but you can view an example of additional
